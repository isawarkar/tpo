...
public class FBNUtil {
	...
	public static void showNoticeNotification(Context context, int size, Intent intent) {
		...
		Notification notification = new Notification.Builder(context, CHANNEL_ID)
				...
				.addAction(R.drawable.icon_login_tab, context.getString(R.string.Show_List), actionPendingIntent)
				.build();
		NotificationManager mNotificationManager = (NotificationManager) context
				.getSystemService(Context.NOTIFICATION_SERVICE);
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
	...
	private static boolean haveNetworkConnection(Context context) {
		...
		// or if function is out side of your Activity then you need context of
		// your Activity
