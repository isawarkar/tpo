...
public class FullQRImageActivity extends Parent {
	...
	public void onCreate(Bundle savedInstanceState) {
		try {
			...
			final String fileName = registerdEnrollment + ".png";
			...
			if (file.exists()) {
				...
				downloadNotice.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						FBNUtil.showProgress(FullQRImageActivity.this);
						...
						FBNUtil.hideProgress(FullQRImageActivity.this);
					}
				});
			}
