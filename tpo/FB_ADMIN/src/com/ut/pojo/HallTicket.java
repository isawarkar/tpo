...
public class HallTicket implements java.io.Serializable {
	...
	private String  totalShortlisted;
	...
	public void setTotalArrived(String totalArrived) {
	...
	public String getTotalShortlisted() {
		return totalShortlisted;
	}

	public void setTotalShortlisted(String totalShortlisted) {
