...
public class ApproveOrRejectTask extends AsyncTask<String, Void, String> {
	JSONObject registerObject;
	Context context;
	private Activity parentActivity;

	public ApproveOrRejectTask(Context contex, JSONObject registerObject, Activity parentActivity) {
		this.context = contex;
	...
	protected String doInBackground(String... urls) {
		...
		try {
			response = FBNUtil.callWebService(context,registerObject, WSURL.APPROVE_OR_REJECT);
		} catch (Exception e) {
			e.printStackTrace();
