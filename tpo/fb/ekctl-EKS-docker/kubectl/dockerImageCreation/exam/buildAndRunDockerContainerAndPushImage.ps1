...
docker tag exam-image:latest 542115677157.dkr.ecr.us-east-1.amazonaws.com/exam:latest
...
docker push 542115677157.dkr.ecr.us-east-1.amazonaws.com/exam:latest
