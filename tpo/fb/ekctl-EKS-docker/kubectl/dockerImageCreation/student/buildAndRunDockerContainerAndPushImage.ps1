...
copy D:\Mywork\$appname\target\$appname.war $appname.war
...
docker tag student-image:latest 542115677157.dkr.ecr.us-east-1.amazonaws.com/student:latest
...
docker push 542115677157.dkr.ecr.us-east-1.amazonaws.com/student:latest
