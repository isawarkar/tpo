...
public class AES {
	...
	public static void main(String[] args) {
		...
		/*
		 * String decryptedValue2 = symmetricDecrypt("nG/NkQjAgmaix9R2fLUrPA==",
		 * secretKey); System.out.println(decryptedValue2); System.out.println("hhhh" +
		 * Base64.encodeBase64("I am smart then you".getBytes()));
		 */
