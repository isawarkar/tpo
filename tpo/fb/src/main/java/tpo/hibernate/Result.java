...
public class Result implements Serializable, JSONAware {
	...
	public String toJSONString() {
		...
		String certFileName = "Certificate_" + testName + "_"
				+ id.getLoginname() + "_" + totalnumbers
				+ ".pdf";
		byte[] certificate = fileUploadUtility.downloadFileWithParam("/download", certFileName, IMAGECONS.student.toString() + id.getLoginname()+"/" + IMAGECONS.certificate.toString());
		if(certificate != null) {
