...
public class Parent extends Activity {
	 ...
	 * Method which navigates from Login Activity to Home Activity
	 */
	public void navigateToFullProfileImageActivity() {
		Intent homeIntent = new Intent(getApplicationContext(), FullProfileImageActivity.class);
		homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startActivity(homeIntent);
	}
	 ...
	 * Method which navigates from Login Activity to Home Activity
	 */
	public void navigateToQRProfileImageActivity() {
		Intent homeIntent = new Intent(getApplicationContext(), FullQRImageActivity.class);
		homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startActivity(homeIntent);
	}
